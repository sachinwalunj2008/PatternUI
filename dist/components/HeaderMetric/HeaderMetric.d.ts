...
declare const HeaderMetric: ({ callout, change, checkboxColor, className, currency, customSecondaryValue, decimalScale, fontSize, formatType, isChecked, isNeutralColor, linkTo, loading, metricIcon, metricValueClassName, pctChange, reverse, roundNumber, secondaryInfo, showLessThanZeroPercentageChange, showRadio, title, tooltip, truncateValues, value, metricTooltip, }: HeaderMetricProps) => JSX.Element;

...
type SortColumnProps<OptionItem extends SortColumnOptionsProps> = SortColumnPropsSingleValue | SortColumnPropsMultipleValues<OptionItem>;
...
declare const SortColumn: <OptionItem extends SortColumnOptionsProps>({ label, propName, options, sorter, customClass, active, localStorageName, lowerCaseParam, tooltip, filter, activeFilters, noSort, columnHeaderSubContent, }: SortColumnProps<OptionItem>) => JSX.Element;

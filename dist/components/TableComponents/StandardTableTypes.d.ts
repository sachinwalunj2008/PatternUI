...
export type StandardTableProps<DataItem, ConfigItem extends ConfigItemType<DataItem, Record<string, unknown>>> = {
...
export type NestedRowPropsType<DataItem, ConfigItem extends ConfigItemType<DataItem, Record<string, unknown>>> = {

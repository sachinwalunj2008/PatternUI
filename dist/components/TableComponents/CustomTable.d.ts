...
type CustomTableProps<HeaderItem extends HeaderItemType<Record<string, unknown>>> = CustomTablePropsWithHeaders<HeaderItem> | CustomTablePropsWithCustomHeaders;
...
declare const CustomTable: <HeaderItem extends HeaderItemType<Record<string, unknown>>>({ hasData, hasMore, successStatus, loading, tableId, noDataFields, sort, sortBy, getData, children, headers, customHeaders, headerChildren, stickyTableConfig, customHeight, customWidth, widthOffset, activeFilters, removeFilters, shortListLoading, }: CustomTableProps<HeaderItem>) => JSX.Element;

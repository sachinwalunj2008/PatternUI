...
declare const Sidebar: <ContentItem extends Content, Breadcrumb extends B>({ startAtBottom, sidebarWidth, toggleDisabled, updatePage, children, content, sidebarFooter, activeIdentifier, highlightOrigin, breadcrumbs, showMobileMenu, isBannerDisplay, }: SidebarProps<ContentItem, Breadcrumb>) => JSX.Element;

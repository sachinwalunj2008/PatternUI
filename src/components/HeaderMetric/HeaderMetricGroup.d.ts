...
declare const HeaderMetricGroup: ({ data, mainCallOut, showRadio, otherMetricCount, activeMetrics, loading, styleBottom, colors, }: HeaderMetricGroupProps) => JSX.Element;
